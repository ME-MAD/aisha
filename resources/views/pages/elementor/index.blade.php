            ...
            <div class="breadcrumb bg-transparent">
                ...
                <div class="breadcrumb-four">
                    <ul class="breadcrumb">
                        ...
                        <li class="active">
                            <a href="{{route('admin.elementor.index')}}"
                            class="d-flex justify-content-center align-items-center">
...
@section('content')
            ...
            <div class="col-lg-12">
                <div class="card ">
                    <div class="card-header d-flex justify-content-between align-items-center card__header__for_tables">
                        ...
                        @check_permission('store-elementor')
                        <a class="icon text-white" data-target='#creatElementorModal' data-toggle='modal'>
    ...
    @include('pages.elementor.createModal')

    @include('pages.elementor.editModal')
@endsection
