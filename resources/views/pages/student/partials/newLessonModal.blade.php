<div class="modal fade" id="newLessonModal" tabindex="-1" role="dialog" aria-labelledby="newLessonModal"
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header card-header create__form__newLesson">
                <h5 class="modal-title font-weight-bold text-capitalize text-light" id="newLessonModal"> 
                    ...
                    <div class="row mb-3">
                        <div class="col">
                            <input class="text-dark form-control" id="from_chapter" name="from_chapter"
                                   placeholder="{{trans('student.from_chapter')}}" type="number">
                        </div>
                        <div class="col">
                            <input class="text-dark form-control" id="to_chapter" name="to_chapter"
                                   placeholder="{{trans('student.to_chapter')}}" type="number">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col">
                            <input class="text-dark form-control" id="from_page" name="from_page"
                                   placeholder="{{trans('student.from_page')}}" type="number">
                        </div>
                        <div class="col">
                            <input class="text-dark form-control" id="to_page" 
                                   name="to_page" placeholder="{{trans('student.to_page')}}"
                                   type="number">
                        </div>
                    </div>
