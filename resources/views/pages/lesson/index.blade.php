                                        ...
                                        <table id="style-3" class="table style-3  table-hover">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="text-center">subject_id</th>
                                            ...
                                            <tbody>
                                                @foreach ($lessons as $lesson)
                                                    <tr role="row">
                                                        ...
                                                        <td>
                                                            <a href="{{ route('admin.subject.index', $lesson->id) }}"  class="text-primary">
                                                                {{ $lesson->Subject->name }}
                                                            </a>
                                                        </td>
                                                        <td class="checkbox-column text-center sorting_1">
                                                        ...
                                                        <td class="text-center">
                                                            <div class="links--ul">
                                                                <x-edit-link :route="route('admin.lesson.edit', $lesson->id)" />
                                                            </div>
                                                        </td>
                                                        <td class="text-center">
                                                            <div class="links--ul">
                                                                <x-delete-link :route="route('admin.lesson.delete', $lesson->id)" />
                                                            </div>
                                                        </td>
                                                    </tr>
                                                @endforeach
