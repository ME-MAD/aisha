<div class="modal fade" id="creatGroupDayModal" tabindex="-1" role="dialog" aria-labelledby="creatGroupDayModal"
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header p-3 mb-2 bg-primary font-weight-bold text-capitalize">
            ...
            <div class="modal-body">
                <form action="{{ route('admin.group_day.store') }}" method="post">
                    ...
                    <div class="modal-footer">
                        <button type="submit"
                                class="btn btn-primary font-weight-bold text-capitalize"> {{ __('globalWorld.Save') }}</button>
