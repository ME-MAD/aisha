        ...
        <div class="dropdown filter custom-dropdown-icon">
            ...
            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="filterDropdown">
                ...
                <a class="dropdown-item" data-value="<span>Show</span> : Weekly Analytics"
                    href="{{ route('admin.group.create') }}">Edit Group</a>
            </div>
        </div>
    </div>
@endsection
                    ...
                    <div class="widget-header">
                        <div class="row align-items-center">
                            ...
                            <div class="col-xl-2 col-md-2 col-sm-2 col-2">
                                <a href="{{ route('admin.group.create') }}" class="btn btn-primary float-right">Edit</a>
                            </div>
                        </div>
                    </div>
                                            ...
                                            <tbody>
                                                @foreach ($grouptypes as $grouptype)
                                                    <tr role="row">
                                                        ...
                                                        <td>
                                                                <a href="{{ route('admin.group.index', $grouptype->id) }}"  class="text-primary">
                                                                    {{ $grouptype->group->from }} -  {{ $grouptype->group->to }}
                                                                </a>
                                                        </td>
                                                        ...
                                                        <td class="text-center">
                                                            <div class="links--ul">
                                                                <x-edit-link :route="route('admin.group_types.edit', $grouptype->id)" />
                                                            </div>
                                                        </td>
                                                        <td class="text-center">
                                                            <div class="links--ul">
                                                                <x-delete-link :route="route('admin.group_types.delete', $grouptype->id)" />
                                                            </div>
                                                        </td>
                                                    </tr>
                                                @endforeach
